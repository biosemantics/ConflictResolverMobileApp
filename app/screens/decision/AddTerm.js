    ...
    return (
        <React.Fragment>
            <ScrollView contentContainerStyle={{backgroundColor: "#fff", flexDirection: 'column', justifyContent: 'space-between'}} keyboardShouldPersistTaps="handled">
                ...
                <ScrollView contentContainerStyle={{padding: 10, paddingTop: 3}} style={{height: deviceHeight - 270}} nestedScrollEnabled={true} keyboardShouldPersistTaps="handled">
                    ...
                    {
                        options && options.sentence && options.sentence.length == 0 &&
                            <Text style={{marginLeft: 15}}> Example sentences not available </Text>
                    }
                    ...
                    <View style={{padding: 10}}>
                        <View style={{flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between'}}>
                            <Text style={{color: 'black', width: '65%'}}>
                                Is {task.term} a structure or a character? 
                                {
                                    ...
                                    <Text style={{color: 'black'}}> Character({options.characterCount})</Text>
                                }
                                {
                                    options && options.structureCount > 0 &&
                        ...
                        </View>
                        {
                            ...
                            <View>
                                ...
                                {
                                    options && options.characterSubpartData && options.characterSubpartData.length > 0 &&
                                    options.characterSubpartData.map((subpart, index) => (
                                        <Text style={{color: 'black'}} key={'characterSubPart'+index}> {subpart.name}({subpart.count}) </Text>
                                    ))
                                }
                                </View>
                        ...
                        }
                        {
                            ...
                            <View>
                                <Text style={{color: 'black'}}>
                                    Select a structure that has {task.term} as a subclass.
                                </Text>
                                <View style={{flexDirection: 'row'}}>
                                <Text style={{color: 'black'}}> Other's decisions: </Text>
                                {
                                    options && options.subclassOfData && options.subclassOfData.length > 0 &&
                                    options.subclassOfData.map((ind, index) => (
                                        <Text style={{color: 'black'}} key={'subclassof'+index}> {ind.name}({ind.count}) </Text>
                                    ))
                                }
                                </View>
                                ...
                                <View style={{ marginBottom: 10, borderBottomWidth: 1, borderColor: 'grey', paddingBottom: 5}}>
                                    ...
                                    <View style={{textAlign: "left"}}>
                                        ...
                                        <Text style={{color: 'black'}}> Other's decisions: </Text>
                                        {
                                            options && options.alwaysPartOfData && options.alwaysPartOfData.length > 0 &&
                                            options.alwaysPartOfData.map((ind, index) => (
                                                <Text style={{color: 'black', marginLeft: 5}} key={'alwaysPartOf'+index}> {ind.name}({ind.count}) </Text>
                                            ))
                                        }
                                        </View>
                                    </View>
                                ...
                                <View style={{ marginBottom: 10, borderBottomWidth: 1, borderColor: 'grey', paddingBottom: 5}}>
                                    ...
                                    <View style={{textAlign: "left"}}>
                                        ...
                                        <Text style={{color: 'black'}}> Other's decisions: </Text>
                                        {
                                            options && options.alwaysHasPartData && options.alwaysHasPartData.length > 0 &&
                                            options.alwaysHasPartData.map((ind, index) => (
                                                <Text style={{color: 'black', marginLeft: 5}} key={'alwaysHasPart'+index}> {ind.name}({ind.count}) </Text>
                                            ))
                                        }
                                        </View>
                                    </View>
                                ...
                                <View style={{ marginBottom: 10, borderBottomWidth: 1, borderColor: 'grey', paddingBottom: 5}}>
                                    ...
                                    <View>
                                        ...
                                        <Text style={{color: 'black'}}> Other's decisions: </Text>
                                        {
                                            options && options.maybePartOfData && options.maybePartOfData.length > 0 &&
                                            options.maybePartOfData.map((ind, index) => (
                                                <Text style={{color: 'black', marginLeft: 5}} key={'maybePartOf'+index}> {ind.name}({ind.count}) </Text>
                                            ))
                                        }
                                        </View>
                                    </View>
                                ...
                                <View style={{ marginBottom: 10, borderBottomWidth: 1, borderColor: 'grey', paddingBottom: 5}}>
                                    ...
                                    <View>
                                        <View style={{width: '100%', marginLeft: 5, flexDirection: 'row'}}>
                                            <Text style={{color: 'black'}}> Other's decisions: </Text>
                                            {
                                                options && options.subpartData && options.subpartData.length > 0 &&
                                                options.subpartData.map((ind, index) => (
                                                    <Text style={{color: 'black', marginLeft: 5}} key={'subpart'+index}> {ind.name}({ind.count}) </Text>
                                                ))
                                            }
                                        </View>
                                    </View>
                                ...
                                <View style={{ marginBottom: 10, borderBottomWidth: 1, borderColor: 'grey', paddingBottom: 5}}>
                                    ...
                                    <View>
                                        <View style={{width: '100%', marginLeft: 5, flexDirection: 'row'}}>
                                            <Text style={{color: 'black'}}> Other's decisions: </Text>
                                            {
                                                options && options.superpartData && options.superpartData.length > 0 &&
                                                options.superpartData.map((ind, index) => (
                                                    <Text style={{color: 'black', marginLeft: 5}} key={'superpart'+index}> {ind.name}({ind.count}) </Text>
                                                ))
                                            }
                                        </View>
                                    </View>
                        ...
                        }
                        {
                            <View>
                                <View style={{...styles.inputContainer, marginTop: 15}}>
                                    <TextInput placeholder={"Enter a term exchangable with " + task.term} style={{color: '#003458', width: '75%', marginLeft: 5}} onChangeText={txt => {setSynonym(txt)}}>{synonym}</TextInput>
                                    <TouchableOpacity disabled={synonym=='' } style={{...styles.button, backgroundColor: (synonym=='' )?'grey':'#003458'}} onPress={() => {
