    ...
    return (
        ...
        <ScrollView contentContainerStyle={{backgroundColor: "#fff", flexDirection: 'column', justifyContent: 'space-between'}} keyboardShouldPersistTaps="handled">
            ...
            <View style={{alignContent: 'center', alignItems: 'center', width: '100%', backgroundColor: 'green', padding: 10, paddingTop: 2, paddingBottom: 2}}>
                <Text style={{...styles.sentence, color: '#fff'}}>Which of the following terms are exchangable with {task.term}, regardless of context?</Text>
            </View>
            </View>
            <ScrollView contentContainerStyle={{padding: 10}} style={{ height: deviceHeight - 265}} nestedScrollEnabled={true} keyboardShouldPersistTaps="handled">
                {
