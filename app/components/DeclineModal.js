          ...
          <Modal isVisible={props.isVisible} deviceWidth={deviceWidth} deviceHeight={deviceHeight}>
            <View style={styles.modalContainer}>
              <View style={styles.modalContent}>
                ...
                <Text style={{...styles.text, fontSize: 15, lineHeight: 20, marginLeft: 10, marginRight: 10, marginBottom: 20, color: '#F4463A'}}>
                  {message}
                </Text>
                <View style={{flexDirection: 'row'}}>
                  <View
                    ...
                    <TouchableOpacity style={styles.button} onPress={showConfirmModal} disabled={reason == ''}>
                      <Text style={{...styles.text, fontSize: 19, lineHeight: 24, color: reason == '' ? '#BFCFDB' : '#003458'}}>{yes}</Text>
                    </TouchableOpacity>
                  </View>
