        ...
        deviceHeight={deviceHeight}>
            <View style={styles.modalContainer} >
                <View style={styles.modalContent}>
                    ...
                    {
                        stateMessage !== '' &&
                        <Text style={{...styles.text, fontSize:15, lineHeight:20, marginLeft:10, marginRight:10, marginBottom:20, marginTop: 15}}>{stateMessage}</Text>
                    }
                    {
                        message !== '' &&
                        <Text style={{...styles.text, fontSize:15, lineHeight:20, marginLeft:10, marginRight:10, marginBottom:20, color:'#E94C36'}}>{message}</Text>
                    }
                    {
                        isReason === true &&
                        <View style={styles.inputContainer}>
                            <TextInput placeholder={placeholder} style={{color: '#003458', marginLeft: 5}} multiline={true} numberOfLines={3} onChangeText={txt => {props.handleChangeReason(txt)}}>{props.reason}</TextInput>
                        </View>
                    }
